import{R as r,d as f,a as y,u as g,S as h,c as H,o as I,A as C,b as E,r as M,e as w,s as _,g as R}from"./sounds-D8zRJubN.js";import{T as x,B as v,M as d}from"./battle-D-ymtSOf.js";import{C as S,D}from"./dice-DwlbI5xZ.js";const k={playerSheets:{},playerInitMods:{},listeners:[],npcTemplates:[{name:"Orc",hp:30,type:x.ENEMY,color:"#dc2626"},{name:"Goblin",hp:10,type:x.ENEMY,color:"#16a34a"},{name:"Esqueleto",hp:20,type:x.ENEMY,color:"#e5e5e5"},{name:"Lobo",hp:15,type:x.ENEMY,color:"#6b7280"},{name:"Mago",hp:25,type:x.NPC,color:"#3b82f6"},{name:"Aldeão",hp:8,type:x.NPC,color:"#92400e"},{name:"Guarda",hp:20,type:x.NPC,color:"#1e40af"}],async initialize(){if(!r.isMaster){console.warn("MasterSystem: Apenas o mestre pode inicializar");return}await this.subscribeToPlayerSheets(),await this.subscribeToPlayerInitMods()},async subscribeToPlayerInitMods(){const e=r.currentRoomCode;if(!e)return;const a=E(M(w,`rooms/${e}/playerInitMods`),t=>{this.playerInitMods=t.val()||{}});this.listeners.push({ref:`rooms/${e}/playerInitMods`,listener:a,type:"rtdb"})},async subscribeToPlayerSheets(){const e=r.currentRoomCode;if(!e)return;const a=H(y,"sheets",e,"players"),t=I(a,n=>{n.forEach(s=>{var u;const i={id:s.id,...s.data()},o=this.playerSheets[s.id],l=o&&o.avatarUrl!==i.avatarUrl;s.id!==((u=C.currentUser)==null?void 0:u.uid)&&(this.playerSheets[s.id]=i),l&&this.syncPlayerToken(s.id)}),this.renderPlayerSheets()});this.listeners.push({ref:a,listener:t,type:"firestore"})},renderPlayerSheets(){const e=document.getElementById("masterPlayerSheets");if(!e)return;const a=Object.values(this.playerSheets);if(a.length===0){e.innerHTML='<p class="text-muted">Nenhuma ficha de jogador ainda</p>';return}e.innerHTML=a.map(t=>{var i,o;const n=Math.max(0,Math.min(100,(t.hp||0)/(t.hpMax||20)*100)),s=t.avatarUrl?`<img src="${t.avatarUrl}" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`:`<span style="font-size:1.2rem;">${((o=(i=t.name)==null?void 0:i[0])==null?void 0:o.toUpperCase())||"?"}</span>`;return`
    ...
    `,document.body.appendChild(i),i.querySelector("#_npcName").focus(),i.addEventListener("click",o=>{o.target===i&&i.remove()}),i.querySelector("#_npcCancel").addEventListener("click",()=>i.remove()),i.querySelector("#_npcConfirm").addEventListener("click",()=>{if(this._npcCreating)return;const o=i.querySelector("#_npcName").value.trim()||"NPC",l=Math.max(1,parseInt(i.querySelector("#_npcHp").value)||20),u=Math.max(1,parseInt(i.querySelector("#_npcHpMax").value)||20);i.remove(),this._createNpc(e,o,l,u)}),i.querySelector("#_npcName").addEventListener("keydown",o=>{o.key==="Enter"&&i.querySelector("#_npcConfirm").click()})},_createNpc(e,a,t,n){if(this._npcCreating)return;this._npcCreating=!0,setTimeout(()=>{this._npcCreating=!1},5e3);const s={hostile:"#dc2626",neutral:"#ca8a04",friendly:"#16a34a"},i={hostile:"enemy",neutral:"npc",friendly:"friendly"};this.npcCards||(this.npcCards={});const o={id:`npc_${Date.now()}`,name:a,hp:t,hpMax:n,status:"—",alignment:e,type:i[e]||"npc",color:s[e]||"#888"};this.npcCards[o.id]=o,this._renderNpcCard(o);try{h.playNotification()}catch{}},_renderNpcCard(e){var $;const a=document.getElementById("npcCardsContainer");if(!a)return;const t={hostile:"#dc2626",neutral:"#ca8a04",friendly:"#16a34a"},n={hostile:"Hostil",neutral:"Neutro",friendly:"Amigável"},s=["—","Caído","Sangrando","Paralizado","Atordoado","Envenenado","Assustado","Cego"],i=t[e.alignment]||e.color||"#888",o=n[e.alignment]||"NPC",l=Math.max(0,Math.min(100,e.hp/e.hpMax*100)),u=l>50?"#16a34a":l>25?"#ca8a04":"#dc2626";($=document.getElementById(`npc-card-${e.id}`))==null||$.remove();const p=document.createElement("div");p.id=`npc-card-${e.id}`,p.draggable=!0,p.style.cssText=`
    ...
    `,p.addEventListener("click",c=>{var T;const m=(T=c.target.closest("[data-action]"))==null?void 0:T.dataset.action;m&&(m==="remove"&&this._removeNpc(e.id),m==="hp-minus"&&this._adjustNpcHP(e.id,-1),m==="hp-plus"&&this._adjustNpcHP(e.id,1),m==="hpmax-minus"&&this._adjustNpcHPMax(e.id,-1),m==="hpmax-plus"&&this._adjustNpcHPMax(e.id,1),m==="map"&&this.dragNpcToMap(e.id))}),p.querySelector('[data-action="hp-input"]').addEventListener("change",c=>{this._setNpcHP(e.id,c.target.value)}),p.querySelector('[data-action="hpmax-input"]').addEventListener("change",c=>{this._setNpcHPMax(e.id,c.target.value)}),p.querySelector('[data-action="status"]').addEventListener("change",c=>{this._setNpcStatus(e.id,c.target.value)}),p.addEventListener("dragstart",c=>{c.dataTransfer.setData("npcCard",JSON.stringify(e)),c.dataTransfer.effectAllowed="copy"}),a.appendChild(p)},_adjustNpcHP(e,a){var n;const t=(n=this.npcCards)==null?void 0:n[e];t&&(t.hp=Math.max(0,Math.min(t.hpMax,t.hp+a)),this._updateNpcCardHP(e,t.hp,t.hpMax),this._syncNpcToken(e,t.hp))},_adjustNpcHPMax(e,a){var n;const t=(n=this.npcCards)==null?void 0:n[e];t&&(t.hpMax=Math.max(1,t.hpMax+a),t.hp>t.hpMax&&(t.hp=t.hpMax),t.hp/t.hpMax*100,this._updateNpcCardFull(e,t.hp,t.hpMax),this._syncNpcToken(e,t.hp))},_setNpcHPMax(e,a){var n;const t=(n=this.npcCards)==null?void 0:n[e];t&&(t.hpMax=Math.max(1,parseInt(a)||1),t.hp>t.hpMax&&(t.hp=t.hpMax),this._updateNpcCardFull(e,t.hp,t.hpMax),this._syncNpcToken(e,t.hp))},_setNpcHP(e,a){var n;const t=(n=this.npcCards)==null?void 0:n[e];t&&(t.hp=Math.max(0,Math.min(t.hpMax,parseInt(a)||0)),this._updateNpcCardHP(e,t.hp,t.hpMax),this._syncNpcToken(e,t.hp))},_updateNpcCardHP(e,a,t){const n=Math.max(0,Math.min(100,a/t*100)),s=document.querySelector(`#npc-card-${e} [data-action="hp-bar"]`),i=document.querySelector(`#npc-card-${e} [data-action="hp-input"]`);s&&(s.style.width=n+"%",s.style.background=n>50?"#16a34a":n>25?"#ca8a04":"#dc2626"),i&&(i.value=a)},_updateNpcCardFull(e,a,t){const n=document.getElementById(`npc-card-${e}`);if(!n)return;const s=Math.max(0,Math.min(100,a/t*100)),i=n.querySelector('[data-action="hp-bar"]'),o=n.querySelector('[data-action="hp-input"]'),l=n.querySelector('[data-action="hpmax-input"]');n.querySelector('[data-action="hpmax-display"]'),i&&(i.style.width=s+"%",i.style.background=s>50?"#16a34a":s>25?"#ca8a04":"#dc2626"),o&&(o.value=a),l&&(l.value=t);const u=n.querySelector('[data-action="hpmax-display"]');u&&(u.textContent=`/${t}`)},_setNpcStatus(e,a){var n;const t=(n=this.npcCards)==null?void 0:n[e];t&&(t.status=a,this._renderNpcCard(t))},_removeNpc(e){var a;this.npcCards&&delete this.npcCards[e],(a=document.getElementById(`npc-card-${e}`))==null||a.remove(),this._syncNpcToken(e,null,!0)},_syncNpcToken(e,a,t=!1){try{const n=Object.values(d.tokens||{}).find(s=>s.npcCardId===e);if(!n)return;t?d.removeToken(n.id):d.updateToken(n.id,{hp:a})}catch{}},adjustNpcHP(e,a){this._adjustNpcHP(e,a)},setNpcHP(e,a){this._setNpcHP(e,a)},setNpcStatus(e,a){this._setNpcStatus(e,a)},removeNpc(e){this._removeNpc(e)},async handleMapDrop(e){e.preventDefault();const a=e.dataTransfer.getData("npcCard");if(a){const n=JSON.parse(a);await d.addToken({name:n.name,type:n.type,hp:n.hp,hpMax:n.hpMax,color:n.color,npcCardId:n.id}),h.playNotification();return}const t=e.dataTransfer.getData("playerCard");if(t){const n=JSON.parse(t);await d.addToken({name:n.name,type:"player",hp:n.hp,hpMax:n.hpMax,avatarUrl:n.avatarUrl,color:"#c9a84c",ownerId:n.playerId}),h.playNotification();return}},async toggleBattleMode(){var n;const e=r.currentRoomCode;if(!e||!r.isMaster)return;const a=!((n=r.currentRoom)!=null&&n.battleMode),t=f(y,"rooms",e);return await g(t,{battleMode:a}),a?(await v.startBattle(),h.playBattleStart()):await v.endBattle(),a},async endSession(){if(!confirm("Tem certeza que deseja encerrar a sessão?"))return;const e=r.currentRoomCode;if(!e)return;const a=f(y,"rooms",e);await g(a,{status:"closed"}),await r.leaveRoom(e),window.location.href="index.html"},cleanup(){this.listeners.forEach(({listener:e})=>{e()}),this.listeners=[],this.playerSheets={}}};window.MasterSystem=k;const j=new URLSearchParams(window.location.search),b=j.get("code");async function q(){try{if(!b){window.location.href="index.html";return}if(await C.waitForInitialization(),!C.isAuthenticated()){window.location.href="index.html";return}if(await r.joinRoom(b),document.getElementById("masterNick").textContent=C.currentNick||"Mestre",await d.initialize("mapContainer"),d.subscribeToMap(),r.subscribeToRoom(b,{onRoomUpdate:a=>{document.getElementById("battleIndicator").classList.toggle("active",a.battleMode),a.battleMode&&(document.getElementById("toggleBattleBtn").textContent="⚔️ Desativar Batalha",document.getElementById("toggleBattleBtn").classList.remove("btn-success"),document.getElementById("toggleBattleBtn").classList.add("btn-danger"))},onPlayersUpdate:a=>{A(a)}}),console.log("[Master] Inicializando Chat e Batalha..."),S.subscribeToChat(b,a=>{typeof renderChatMessages=="function"?renderChatMessages(a):typeof B=="function"&&B(a)}),S.subscribeToDice(b,a=>{typeof renderDiceHistory=="function"?renderDiceHistory(a):typeof N=="function"&&N(a)}),await k.initialize(),await v.initialize(),window.DrawSystem&&(window.DrawSystem.canvas=document.getElementById("drawCanvas"),window.DrawSystem.canvas&&(window.DrawSystem.init(),window.DrawSystem.syncFromRTDB())),r.isMaster){const a=M(w,`rooms/${b}/initiativePhase`);E(a,t=>{const n=t.val(),s=document.getElementById("finalizeInitBtn");s&&(n&&n.active?s.style.display="inline-flex":s.style.display="none")})}const e=document.getElementById("chatInput");e.disabled=!1,e.placeholder="Digite sua mensagem...",document.getElementById("chatSendBtn").disabled=!1,console.log("[Master] Sistemas prontos!")}catch(e){console.error("[Master] Erro crítico na inicialização:",e),alert("Erro ao carregar mesa. Verifique o console.")}}function A(e){const a=document.getElementById("playersList");a.innerHTML=e.map(t=>{var n,s;return`
      ...
      `).join("")||'<p class="text-muted" style="font-size: 0.85rem;">Nenhuma rolagem ainda</p>'}function U(){const e=document.getElementById("tokensList"),a=Object.values(d.tokens||{});e.innerHTML=a.map(t=>`
